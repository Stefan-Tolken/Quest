            ...
            <CardFooter className="flex flex-col gap-2 items-stretch">
              ...
              {progressLoading ? (
                ...
                <div className="w-full flex items-center gap-2">
                  ...
                  {/* Defensive: progress.collectedArtefactIds may be undefined/null */}
                  <span>{Array.isArray(progress?.collectedArtefactIds) ? progress.collectedArtefactIds.length : 0} / {Array.isArray(questToShow.artefacts) ? questToShow.artefacts.length : 0}</span>
                  {progress.completed && <span className="ml-2 text-green-600 font-semibold">Quest Completed!</span>}
                </div>
              ) : null}
              <Button 
                onClick={cancelQuest}
